...
class P49_S28 extends StatefulWidget {
  const P49_S28({super.key});

  @override
  State<P49_S28> createState() => _P49_S28State();
}

class _P49_S28State extends State<P49_S28> {
  ...
  double adjustedTop(int row) {
    ...
    double spacing = 0.135; // space between rows
