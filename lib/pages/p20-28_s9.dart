...
class P20_S9 extends StatefulWidget {
  const P20_S9({super.key});

  @override
  State<P20_S9> createState() => _P20_S9State();
}

class _P20_S9State extends State<P20_S9> {
  ...
  double adjustedTop(int row) {
    double base = 0.174; // top padding adjusted to fit the grid
    double spacing = 0.086; // space between rows
