...
class P34_S16 extends StatefulWidget {
  const P34_S16({super.key});

  @override
  State<P34_S16> createState() => _P34_S16State();
}

class _P34_S16State extends State<P34_S16> {
  ...
  double adjustedLeft(int col) {
    col = 4 - col; // Adjusting column index for left alignment
  ...
  double adjustedTop(int row) {
    double base = 0.353; // top padding adjusted to fit the grid
